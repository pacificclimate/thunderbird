...
test-notebooks-dev: notebook-sanitizer
	...
	@bash -c "poetry shell && env DEV_URL=http://marble-dev01.pcic.uvic.ca:30099/wps pytest --nbval --verbose $(CURDIR)/notebooks/ --sanitize-with $(CURDIR)/docs/output-sanitize.cfg --ignore $(CURDIR)/notebooks/.ipynb_checkpoints"
...
test-notebooks-custom: notebook-sanitizer
	...
	@bash -c "poetry shell && env DEV_URL=http://marble-dev01.pcic.uvic.ca:$(DEV_PORT)/wps pytest --nbval --verbose $(CURDIR)/notebooks/ --sanitize-with $(CURDIR)/docs/output-sanitize.cfg --ignore $(CURDIR)/notebooks/.ipynb_checkpoints"
