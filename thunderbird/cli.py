...
template_env = Environment(
    loader=PackageLoader('thunderbird', 'templates'),
    autoescape=True
)
...
def get_host():
    ...
    url = url or 'http://localhost:5001/wps'
...
@click.option('--port', metavar='PORT', default='5001', help='port in PyWPS configuration.')
